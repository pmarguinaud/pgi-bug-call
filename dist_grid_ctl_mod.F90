...
REAL(KIND=8)    :: ZBUF(4096,COUNT(KFROM(:) == 1),1), ZGP(4096)
INTEGER(KIND=4) :: JFLD,JB,JA,IGLOFF,IGL1,IGL2,IOFF,ILAST, JGL,JLON,ITO,ITAG,J,IRCV, JROC
INTEGER(KIND=4) :: JKGLO,IEND,JROF,IBL, IW,IV, IS, IR, JR, INR, IFLDCOUNT, IFLDLOC(KFDISTG)
INTEGER(KIND=4) :: ISENDREQ(1), IPROC(1), IRCVREQ(1), IOFFPROC(1)
